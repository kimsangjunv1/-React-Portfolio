  ...
  career: [
    {
      ...
      desc: [
        // {
        //     name: "엔조이소프트",
        //     description: "현재 UX/UI 디자인/개선 및 상황별 API 로직에 따라 필요한 컴포넌트 설계를 담당하고 있습니다.",
        //     tags: ["재직중", "2024.11.18", "프론트엔드"]
        // },
        {
          name: "주식회사 메이즈",
          description:
  ...
  education: [
    {
      ...
      imgSrc:
        "https://codi-agit.com/src/assets/images/storage/Img_172881525130312.jpeg",
    ...
    },
    {
      ...
      imgSrc:
        "https://codi-agit.com/src/assets/images/storage/Img_172874317049454.jpeg",
    ...
    },
    {
      ...
      imgSrc:
        "https://codi-agit.com/src/assets/images/storage/Img_172969322691163.jpeg",
    ...
    },
    {
      ...
      imgSrc:
        "https://codi-agit.com/src/assets/images/storage/Img_172874734514029.jpeg",
    ...
    },
    {
      ...
      imgSrc:
        "https://codi-agit.com/src/assets/images/storage/Img_172884056675422.jpeg",
  ...
  projects: [
    {
      ...
      details: [
        ...
        {
          name: "라이브러리",
          description: ["Vite", "Swiper", "Bootstrap"],
        },
      ],
      screenshots: [
    ...
    },
    {
      ...
      details: [
        {
          name: "타입",
          description: ["반응형", "PC", "모바일"],
        },
        {
          name: "프로젝트 규모",
          description: ["사내 사이드 프로젝트"],
        },
        {
          name: "참여도",
          description: ["프론트 100%", "디자인 100%"],
        },
        {
          name: "프레임워크",
          description: ["Next JS"],
        ...
        {
          name: "라이브러리",
          description: ["Framer-Motion", "Matter JS", "Swiper", "Zustand"],
        },
      ],
      screenshots: [
    ...
    },
    {
      ...
      details: [
        ...
        {
          name: "기타",
          description: ["Shazam API", "Mongo DB API"],
        },
        {
          name: "프레임워크",
          description: ["Next JS"],
        ...
        {
          name: "라이브러리",
          description: ["MongoDB", "Zustand", "Swiper"],
        },
      ],
      screenshots: [
    ...
    },
    {
      ...
      details: [
        ...
        {
          name: "라이브러리",
          description: ["GSAP", "Framer-Motion", "Lenis"],
        },
      ],
      screenshots: [
    ...
    },
    {
      ...
      details: [
        ...
        {
          name: "라이브러리",
          description: ["Sun Editor", "Lenis", "SCSS"],
        },
      ],
      screenshots: [
